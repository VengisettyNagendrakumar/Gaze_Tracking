...
# # After calibration, thresholds are set as MULTIPLES of silence RMS:
# #   whisper zone starts at: silence_rms × WHISPER_MULT
# #   speech zone starts at:  silence_rms × SPEECH_MULT
# #   loud zone starts at:    silence_rms × LOUD_MULT
# WHISPER_MULT = 2.5
# SPEECH_MULT  = 5.0
# LOUD_MULT    = 40.0   # was 20 — your speech rms=480, silence=20, so 20×40=800 is safe loud threshold
...
#             # Use 80th percentile of calibration samples as silence floor
#             # (ignores brief sounds during calibration window)
#             silence = float(np.percentile(self._calib_samples, 80))
#             # Cap silence_rms — if something was playing during calibration
#             # (music, fan, AC), percentile can be too high.
#             # Hard cap at 200 prevents calibration from being ruined.
#             silence = max(min(silence, 200), MIN_SILENCE_RMS)
